package com.kotlin.app.lbl.ui.view;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        int mins = dip2px(context, 10);
        int paddings = dip2px(context, 5);
        mTvSpotCount = new TextView(context);
        mTvSpotCount.setBackgroundResource(R.drawable.bg_msg_bubble);
        mTvSpotCount.setMinWidth(mins);
        mTvSpotCount.setTextColor(Color.WHITE);
        mTvSpotCount.setPadding(paddings, 0, paddings, 0);
        mTvSpotCount.setGravity(Gravity.CENTER);
        FrameLayout.LayoutParams tvUnReadParamss = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, min);
        tvUnReadParamss.gravity = Gravity.CENTER;
        tvUnReadParamss.width = dip2px(context,10);
        tvUnReadParamss.height = dip2px(context,10);
        tvUnReadParamss.leftMargin = dip2px(context, 17);
        tvUnReadParamss.bottomMargin = dip2px(context, 14);
        mTvSpotCount.setLayoutParams(tvUnReadParamss);
        mTvSpotCount.setVisibility(GONE);
        addView(mTvSpotCount);
    ...
    public void setTHIRDCount(int num) {
//        mTvUnreadCount.setBackgroundResource(R.drawable.bg_msg_spot_bubble);
        if (num <= 0) {
            mTvSpotCount.setText(String.valueOf(0));
            mTvSpotCount.setVisibility(GONE);
        } else {
            mTvSpotCount.setVisibility(VISIBLE);
//            mTvSpotCount.setText("");
        }
    }
